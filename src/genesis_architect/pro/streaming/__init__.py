...
Public API::
    ...
    from genesis_architect.pro.streaming import CompanionServer, emit, install_hooks
    ...
    from genesis_architect.pro.streaming import events
...
from genesis_architect.pro.streaming.server import CompanionServer, emit
from genesis_architect.pro.streaming.runner_patch import install as install_hooks, uninstall as uninstall_hooks, is_installed
