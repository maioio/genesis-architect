...
def gde_run_architecture_scorer(ctx: SessionContext) -> dict[str, Any]:
    from genesis_architect.pro.architecture_scorer import append_score_history, score_project
...
def gde_run_refactoring_planner(ctx: SessionContext) -> dict[str, Any]:
    from genesis_architect.pro.refactoring_planner import generate_plan, render_refactoring_plan_md
...
def gde_run_research_outline(ctx: SessionContext) -> dict[str, Any]:
    ...
    from genesis_architect.pro.research_outline import load_outline
...
def gde_run_field_intelligence(ctx: SessionContext) -> dict[str, Any]:
    ...
    from genesis_architect.pro.field_intelligence import run_field_workflow
...
def gde_run_evidence_pack(ctx: SessionContext) -> dict[str, Any]:
    ...
    from genesis_architect.pro.evidence_pack import build_evidence_pack
...
def gde_run_committee_analysis(ctx: SessionContext) -> dict[str, Any]:
    ...
    if os.environ.get("ANTHROPIC_API_KEY") and perspectives:
        try:
            from genesis_architect.pro.engines.committee import (
                CommitteeContext,
                CommitteeMode,
                CommitteeRequest,
                TransparencyProfile,
...
def gde_run_rules_engine(ctx: SessionContext) -> dict[str, Any]:
    ...
    project state.
    """
    from genesis_architect.pro.rules_engine import run_check, format_report
...
def gde_run_import_audit(ctx: SessionContext) -> dict[str, Any]:
    ...
    """
    from genesis_architect.pro.import_audit import audit, format_report
...
def gde_run_red_team_critic(ctx: SessionContext) -> dict[str, Any]:
    ...
    from genesis_architect.pro.red_team_critic import critique_session, critique_with_llm
