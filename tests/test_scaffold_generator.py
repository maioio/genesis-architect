...
class TestValidateName:
    def test_simple_name_passes(self):
        from genesis_architect.core.scaffold_generator import _validate_name
...
class TestCreateStructure:
    ...
    def test_path_traversal_blocked(self, tmp_path):
        from genesis_architect.core.scaffold_generator import create_structure, _validate_name
        # inject a path that would escape base_path
        import unittest.mock as mock
        evil_files = ["../../../etc/passwd"]
        with mock.patch("genesis_architect.core.scaffold_generator.STRUCTURES", {"python": {"minimalist": evil_files}}):
...
class TestStructuresIntegrity:
    def test_all_expected_languages_present(self):
        from genesis_architect.core.scaffold_generator import STRUCTURES
