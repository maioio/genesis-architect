...
Usage (minimal):
    from genesis_architect.pro.voice.voice_pipeline import VoicePipeline
...
class ContextPrefetcher:
    ...
    async def _fragility_lookup(self, entity: str) -> dict | None:
        ...
        try:
            from genesis_architect.pro.fragility_classifier import classify_module
    ...
    async def _kg_lookup(self, entity: str) -> dict | None:
        ...
        try:
            from genesis_architect.pro.knowledge_graph import load_graph
            loop = asyncio.get_event_loop()
...
class VoicePipeline:
    ...
    def listen_and_respond(self) -> str:
        ...
        from genesis_architect.pro.voice.listener import listen_stream
    ...
    def _speak_with_bargein(self, text: str) -> None:
        ...
        watcher.start()
        try:
            from genesis_architect.pro.voice.pipeline import Urgency
