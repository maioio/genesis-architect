...
def scan(project_dir: Path) -> dict:
    ...
    try:
        from genesis_architect.pro.model_store import ModelStore
    ...
    try:
        from genesis_architect.pro.drift_detector import compute_drift_flags
    ...
    _anchor_report = None
    try:
        from genesis_architect.pro.source_anchor import anchor_from_store
    ...
    try:
        if _anchor_report is not None and _anchor_report.total_responsibilities > 0:
            from genesis_architect.pro.model_store import ModelStore as _MS
            from genesis_architect.pro.source_anchor import persist_anchors as _pa
    ...
    try:
        from genesis_architect.pro.architecture_scorer import load_score_history
