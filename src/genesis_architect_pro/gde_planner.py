...
_MODE_GATES: dict[GDEMode, list[str]] = {
    GDEMode.RECOVERY: ["CONFIDENCE_LOW", "DRIFT_CRITICAL", "RED_TEAM_CRITICAL"],
    GDEMode.RESEARCH: ["CONFIDENCE_LOW", "RED_TEAM_CRITICAL", "RESEARCH_COVERAGE_LOW"],
    GDEMode.REFACTOR: ["CONFIDENCE_LOW", "DRIFT_CRITICAL", "WRITE_SCOPE", "RED_TEAM_CRITICAL"],
    GDEMode.GATE: ["CONFIDENCE_LOW", "POLICY_VIOLATION", "RED_TEAM_CRITICAL"],
    GDEMode.BUILD: ["CONFIDENCE_LOW", "WRITE_SCOPE", "SECURITY_RISK", "RED_TEAM_CRITICAL"],
    GDEMode.DOCUMENT: ["CONFIDENCE_LOW", "RED_TEAM_CRITICAL"],
    GDEMode.COMMITTEE: ["CONFIDENCE_LOW", "DRIFT_CRITICAL", "WRITE_SCOPE", "RED_TEAM_CRITICAL"],
}
