...
class TestDetectLanguage:
    def test_detects_python_from_pyproject(self, tmp_path):
        ...
        from genesis_architect.pro.import_graph import detect_language
...
class TestPythonImportExtraction:
    def test_extracts_stdlib_and_local_imports(self, tmp_path):
        ...
        """))
        from genesis_architect.pro.import_graph import _extract_python_imports
...
class TestJsTsImportExtraction:
    def test_extracts_relative_imports(self, tmp_path):
        ...
        """))
        from genesis_architect.pro.import_graph import _extract_js_ts_imports
...
class TestGoImportExtraction:
    def test_extracts_block_imports(self, tmp_path):
        ...
        """))
        from genesis_architect.pro.import_graph import _extract_go_imports
...
class TestLayerDetection:
    def test_detects_domain_layer(self):
        from genesis_architect.pro.import_graph import _detect_layer
...
class TestCycleDetection:
    def test_detects_simple_cycle(self):
        from genesis_architect.pro.import_graph import _find_cycles
        adj = {
            "a.py": ["b.py"],
            "b.py": ["a.py"],
            "c.py": [],
