...
### RESEARCH.md
```markdown
# Research Report: [Project Name] | Generated: [date]

## Executive Summary
[2-3 sentences: what exists, ecosystem convergence, why this architecture]
...
## Market Landscape + Architecture Rationale
[Ecosystem summary, convergence signals, why this structure was chosen]
...
### PITFALLS.md
```markdown
# Engineering Pitfalls Report - [N] real-world projects analyzed

## Pitfall 1: [Name]
**Seen in**: [link] | **Frequency**: [N] of [M] repos | **Root cause**: [why] | **Mitigation**: [what we built differently]
[repeat for pitfalls 2-7]
```
